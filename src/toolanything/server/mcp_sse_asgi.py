...
class _ToolInvoker:
    ...
    def audit(self, name: str, arguments: Dict[str, Any], user_id: str) -> Dict[str, Any]:
        return self._audit(name, arguments, user_id)

    def mask(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        return self._mask(arguments)
